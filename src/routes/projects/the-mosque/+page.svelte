...
<svelte:head>
	<title>The Mosque | Iconic Building Lighting Renewal | emittiv</title>
	<meta
		name="description"
		content="Facade lighting renewal for a landmark house of worship in the UAE. Modernisation of over 1,000 fixtures and full control infrastructure while preserving the original design intent."
	/>
	<link rel="canonical" href="https://www.emittiv.com/projects/the-mosque" />
	<meta name="robots" content="index,follow" />

	<!-- Open Graph -->
	<meta property="og:type" content="website" />
	<meta property="og:title" content="The Mosque | Iconic Building Lighting Renewal | emittiv" />
	<meta
		property="og:description"
		content="Facade lighting renewal for a landmark house of worship in the UAE. Modernisation of over 1,000 fixtures while preserving the original design intent."
	/>
	<meta
		property="og:image"
		content="https://www.emittiv.com/img/projects/sheikh-zayed-grand-mosque/hero.jpg"
	/>
	<meta property="og:url" content="https://www.emittiv.com/projects/the-mosque" />
	<meta property="og:site_name" content="emittiv" />
	<meta property="og:locale" content="en_AE" />

	<!-- Twitter Card -->
	<meta name="twitter:card" content="summary_large_image" />
	<meta name="twitter:title" content="The Mosque | Iconic Building Lighting Renewal | emittiv" />
	<meta
		name="twitter:description"
		content="Facade lighting renewal for a landmark house of worship in the UAE. Modernisation of over 1,000 fixtures while preserving original design intent."
	/>
	...
	<section class="hero-bleed">
		<picture>
			...
			<img
				...
				sizes="100vw"
				alt="Landmark mosque facade illuminated at night"
				style="transform: translateY({scrollY * 0.15}px)"
				loading="eager"
			/>
		</picture>
		<div class="hero-overlay">
			<h1 class="tagline">The Mosque</h1>
		...
		<div class="container">
			<div class="split">
				...
				<div class="v-padding-1 f col middle order-2">
					<span
						>after years of operation, the original facade lighting system had reached the end
						of its useful life. the scope included replacement of over 1,000 fixtures and a
						complete lighting control system overhaul comprising
				...
				<div class="split-img {splitRevealed ? 'revealed' : ''}">
					<picture>
						...
						<img
							...
							sizes="(min-width: 768px) 50vw, 100vw"
							alt="Mosque domes illuminated at night"
							loading="lazy"
							width="1440"
							height="965"
						/>
