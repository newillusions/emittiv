...
<svelte:head>
	<title>Architectural Sound Design Dubai | Audio Systems & Soundscapes | emittiv</title>
	<meta
		name="description"
	...
	/>
	<link rel="canonical" href="https://www.emittiv.com/services/sound" />
	...
	<meta property="og:url" content="https://www.emittiv.com/services/sound" />
...
<main>
	...
	<section class="screen-flow content" data-label="Beyond">
		<div class="container">
			<div class="split">
	...
	<section class="screen-flow content" data-label="Networked">
		<div class="container">
			<div class="split">
				<div class="section-title order-1">
	...
	<section class="screen-flow content" data-label="Soundscapes">
		<div class="container">
			<div class="split">
				<div class="section-title order-3">
		...
		<div class="container">
			<div class="split">
				...
				<div class="v-padding-1 f col middle order-2">
					...
					<span class="underline">
						<a class="navItem" href="https://sensory.design/the-senses/#sound" target="_blank" rel="noopener">sound as a sensory medium</a>
					</span>
				</div>
			</div>
		</div>
