...
<svelte:head>
	...
	<meta
		property="og:title"
		content="Architectural Lighting Design Dubai | Dynamic Lighting Systems | emittiv"
	/>
	<meta
		...
		<div class="container">
			<div class="split">
				...
				<div class="v-padding-1 f col middle order-2">
					...
					>
					<span
						><strong>integration</strong> with video and control systems for coordinated effects.</span
					>
				</div>
			</div>
		</div>
